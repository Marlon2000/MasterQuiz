...
class QuestionTextState extends State<QuestionText> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fontSizeAnimationController = new AnimationController(duration: new Duration(milliseconds: 1200), vsync: this);
                ...
                decoration: new BoxDecoration(
                  ...
                  child: new Center(
                    child: new Text("Question " + widget._questionNumber.toString() + ": " + widget._question + "?",
                      style: new TextStyle(fontSize: _fontSizeAnimation.value * 30),
                ),
              ),
             ),
          );
